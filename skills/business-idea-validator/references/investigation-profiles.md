...
1. Selection rule
2. Baseline: demand and workflow
3. Baseline: competition and wedge
4. Baseline: operator and economics
5. Baseline: durability and red team
6. AI, research, advice, and content products
7. Regulated or compliance-sensitive workflows
8. Vertical SaaS and workflow automation
9. Services, productized services, and software studios
10. Marketplaces and network-effect products
11. Consumer and creator products
12. Local, physical, and operational businesses
13. Developer tools and B2B infrastructure

## 1. Selection rule

Use all four baseline profiles for every idea. Add only specialist profiles that can materially change the verdict, gate ratings, pivot, or test. Use no more than three specialist profiles unless the user explicitly requests deep research.

Require every profile to add structured claims to the shared evidence ledger. Do not produce a standalone essay for each profile.

## 2. Baseline: demand and workflow

Determine whether a specific buyer experiences a sufficiently costly, urgent, frequent, risky, or revenue-linked problem to act.

Investigate:

- Buyer, user, beneficiary, and budget owner.
- Exact trigger and frequency.
- Current workflow from trigger to completion.
- People, tools, documents, portals, spreadsheets, emails, calls, and services involved.
- Delays, errors, rework, handoffs, missing information, and anxiety.
...
- Direct products.
- Broad suites with the feature bundled inside.
- Adjacent products that solve part of the workflow.
- Professional services and consultants.
- Internal labor and manual processes.
- Generic tools, templates, spreadsheets, and open-source software.
...
Evaluate whether the opportunity can become a worthwhile business to sell, deliver, and own.

Separate founder fit into:
...
- Buyer and pricing unit.
- Likely price based on value and current alternatives.
- Recurring, usage, transaction, setup, implementation, and service revenue separately.
- Frequency and retention trigger.
- Gross margin after human review, support, data, models, integrations, and compliance.
...
Attack the opportunity's strongest narrative.
...
Treat these as primary substitutes:

- General-purpose AI plus a competent prompt.
- Search and answer engines.
- Existing templates, communities, newsletters, consultants, and agencies.
- Human review or expertise already embedded in a workflow.

Investigate:

- Whether the product creates a better decision or merely more text.
- How output quality is measured against the customer's current method.
- Whether use is episodic, project-based, or recurring.
- Whether users pay for trust, accountability, workflow integration, proprietary evidence, or execution.
- Hallucination, citation, freshness, evaluation, privacy, and model-dependency risks.
- Whether user behavior creates a lawful and decision-relevant feedback loop.
- Why orchestration, multiple agents, or a custom prompt cannot be copied cheaply.

Downgrade products whose main differentiation is prompt complexity, agent count, model choice, or polished report length.

## 7. Regulated or compliance-sensitive workflows

Use primary legal, agency, licensing, and government sources for material boundaries. Determine:

- Jurisdiction and current effective rules.
- Regulated actor, action, advice, decision, or custody function.
- Licensing, registration, insurance, capital, retention, audit, privacy, and security requirements.
- Whether the product can remain workflow software rather than the regulated provider.
- Required human or licensed review.
- Liability after error and realistic recourse.
- Whether variation across jurisdictions destroys MVP simplicity.

Do not assume disclaimers remove liability. Do not reward regulation unless permission or operational learning compounds economically. Prefer organization, completeness checks, evidence, monitoring, routing, and audit readiness over unlicensed advice or guarantees.

## 8. Vertical SaaS and workflow automation

Investigate:

- One exact buyer, trigger, workflow stage, and measurable completion outcome.
- Current systems, documents, portals, email, spreadsheets, and human handoffs.
- Features trapped inside broad suites and reasons customers do not adopt the suite.
- Public APIs, exports, imports, webhooks, email ingestion, CSV, and manual fallback.
- Integration fragility and the cost of becoming a system of record.
- Frequency, portfolio buyers, renewals, monitoring, and retention triggers.
- Implementation and configuration required for the first ten customers.

Prefer coordinating existing infrastructure over replacing an industry. Reject wedges that require many integrations, deep bespoke logic, or unstable browser automation before validation.
...
Distinguish a good service business from a good SaaS business. A service-first version can be the correct destination, not only a temporary MVP.
...
- Geography, route or service density, labor, permits, inventory, scheduling, and seasonality.
- Unit economics by job, location, route, or asset.
- Quality assurance, insurance, safety, cancellations, exceptions, and on-call work.
- Whether local knowledge and repetition improve margins or only add complexity.
- Capital requirements and working-capital timing.
- What software can coordinate versus what still requires physical execution.

Do not call operational difficulty a moat unless density, learning, trust, or purchasing power compounds.

## 13. Developer tools and B2B infrastructure

Separate the user from the economic buyer. Investigate:

- Production incident, security, compliance, cost, migration, or developer-time consequence.
- Open-source, cloud-provider, internal-tool, and free-tier substitutes.
- Integration surface, proof of reliability, security review, and procurement burden.
